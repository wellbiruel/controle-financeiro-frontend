...
export default function TopBar({ widthMode, onToggleWidth }) {
          ...
          {userOpen && (
            <div className="dd-user">
              ...
              <div className="dd-user-body">
                ...
                <div className="dd-user-item" onClick={() => { onToggleWidth(); }}>
                  {widthMode === 'total' ? <IcoCompress /> : <IcoExpand />}
                  {widthMode === 'total' ? 'Modo confortável' : 'Largura total'}
                </div>
