...
const MENU = [
  {
    ...
    itens: [
      ...
      { label: 'Transacoes', path: '/transacoes', icon: 'M3 13h2v-2H3v2zm0 4h2v-2H3v2zm0-8h2V7H3v2zm4 4h14v-2H7v2zm0 4h14v-2H7v2zM7 7v2h14V7H7z' },
  ...
  },
  {
    ...
    itens: [
      ...
      { label: 'Investimentos', path: '/investimentos', icon: 'M3.5 18.49l6-6.01 4 4L22 6.92l-1.41-1.41-7.09 7.97-4-4L2 16.99z' },
    ],
  },
  {
    grupo: 'Analise',
